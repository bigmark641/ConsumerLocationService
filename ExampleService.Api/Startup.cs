...
namespace ExampleService.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IExampleService, ExampleService.Domain.ExampleService>();
            services.AddScoped<IExampleAdapter, ExampleService.Infrastructure.ExampleAdapter>();
        }
